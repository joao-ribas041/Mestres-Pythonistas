...
# Como contatenar(combinar) strings
...
# ​Desafio 1: Transforme a frase1 em uma lista de palavras e guarde o resultado em uma
# variável chamada palavras1

# Desafio 2: Transforme a frase2 em uma lista de palavras e guarde o resultado em uma
# variável chamada palavras2

# Desafio 3: Pegue o palavras1 e transforme elas no seguinte
# string: "Desafio,manipulação,de,strings". Imprima o resultado no console.
